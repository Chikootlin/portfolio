...
export default function ProjectCard({ project }: { project: Project }) {
    ...
    return (
        <>
            <div className="bg-[#454B6B] rounded-2xl overflow-hidden border border-[#7EA2C7] transition hover:scale-105">
                {/* image */}
                ...
                <div className="p-4 md:p-6">
                    ...
                    <p
                        className="text-gray-300 text-sm leading-relaxed line-clamp-3 md:line-clamp-4">
                        {desc}
                    </p>
